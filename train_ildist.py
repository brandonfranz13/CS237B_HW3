    ...
    def __init__(self, in_size, out_size):
        ...
        self.model = tf.keras.Sequential(
            [
                ...
                tf.keras.layers.Dense(10, activation = 'tanh', name = 'L1', kernel_initializer='glorot_normal', bias_initializer='zeros'),
                tf.keras.layers.Dense(10, activation = 'tanh', name = 'L2', kernel_initializer='glorot_normal', bias_initializer='zeros'),
